			...
			E = {
				...
				shack_02: {
					...
					floor: {
						surfaces: [{
							type: "shack",
							collision: [A.createAabbExtents(L.create(0, 1), L.create(5, 4)), D.createAabbExtents(L.create(3.75, -4), L.create(2.25, 1.5))]
						}],
						imgs: [{
					...
					ceiling: {
						scopeIn: [A.createAabbExtents(L.create(0, 1), L.create(5, 4))],
						scopeOut: [A.createAabbExtents(L.create(0, 1), L.create(0, 0))],
						vision: {
							width: 4
						},
						imgs: [{
