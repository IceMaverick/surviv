webpackJsonp([0], {
				...
				function e(t) {
					...
					for (var N = 0; N < this.dom.loot.length; N++) {
						var q = this.dom.loot[N],
							V = g.items[q.lootType];
						"heal" != V.type && "boost" != V.type || B("use", "loot", q.lootType, q.div), B("drop", "loot", q.lootType, q.div)
					}
					for (var G = 0; G < this.dom.gear.length; G++) {
						var U = this.dom.gear[G];
						"backpack" != U.gearType && B("drop", "loot", U.gearType, U.div)
					}
					for (var W = 0; W < this.itemActions.length; W++) ! function(e) {
						var t = a.itemActions[e];
						L("mousedown", t.div, function(e) {
							("use" == t.action && r(e) || "drop" == t.action && s(e)) && (e.stopPropagation(), t.actionQueued = !0)
						}), L("mouseup", t.div, function(e) {
							t.actionQueued && ("use" == t.action && r(e) || "drop" == t.action && s(e)) && (e.stopPropagation(), a.pushAction(t), t.actionQueued = !1)
						}), L("touchstart", t.div, function(e) {
				...
				return u(e, [{
					...
					value: function(e, t, a, i, o, n) {
						...
						var C = P.None,
							...
							z = !0;
						if (!t.netData.dead) {
							for (var A = null, D = 0, O = n.obstaclePool.getPool(), E = 0; E < O.length; E++) {
								var L = O[E];
								if (L.active && !L.dead && x.sameLayer(L.layer, t.layer)) {
									var B = L.getInteraction();
									if (B) {
										var F = h.intersectCircle(L.collider, t.netData.pos, B.rad);
										F && F.pen >= D && (A = L, D = F.pen)
									}
								}
							}
							...
							if (R && !t.netData.downed) {
								var j = g.items[R.name],
									...
									V = N && q,
									G = "gun" != j.type || !V || "gun" == t.equippedWeaponType();
						...
						for (var C = 0; C < e.weapons.length; C++) {
							...
							if (I.name) {
								...
								if (D) {
									...
									O = this.localization.translate("game-hud-" + A.name) || this.localization.translate("game-" + A.name), E = B.lootImg.sprite, L = B.isDual && k.layout == k.Layout.Sm
								}
								z.name.innerHTML = O, z.image.src = E, z.image.style.display = D ? "inline" : "none", z.image.style.transform = L ? "rotate(0deg)" : ""
							}
					...
					value: function(e, t, a, i, o) {
						switch (e = _.htmlEscape(e || ""), t = _.htmlEscape(t || ""), i) {
							case w.Player:
			...
			w = function() {
				function e() {
					i(this, e), this.display = {
						...
						places: [],
						objects: []
					}, this.dataLoaded = !1, this.mapTexture = null, this.obstaclePool = new u.Pool(v), this.lootSpawnerPool = new u.Pool(_), this.buildingPool = new u.Pool(x), this.structurePool = new u.Pool(k), this.deadObstacleIds = [], this.deadCeilingIds = [], this.terrain = null, this.ripples = []
				}
				return r(e, [{
					key: "free",
					value: function() {
					...
					value: function(e, t, a, i, o, n) {
						...
						for (var u = this.structurePool.getPool(), h = 0; h < u.length; h++) {
							var g = u[h];
							g.active && g.update(n)
						}
								...
								if (b.delay -= e, b.delay <= 0 && (b.life -= e, b.scale += .5 * e, b.alpha -= e), b.life < 0) b.sprite.visible = !1;
									...
									if (b.relPos) {
										var v = b.sprite.parent,
											k = p.create(v.position.x, v.position.y),
											_ = v.scale.x,
											w = v.rotation;
										y = n.pointToScreen(y), y = p.rotate(p.mul(p.sub(y, k), 1 / _), -w), x = x * this.display.water.scale.x / _
									}
					...
					value: function(e, t, a) {
						...
						t.beginFill(h.water), t.moveTo(d.x, d.y), t.lineTo(m.x, m.y), t.lineTo(c.x, c.y), t.lineTo(l.x, l.y), n(t, s.shore), t.addHole(), t.closePath(), e.beginFill(h.beach), n(e, s.shore), n(e, s.grass), e.addHole(), e.endFill(), e.beginFill(h.grass), n(e, s.grass), e.endFill(), e.lineStyle(a, 0, .15);
						...
						for (var u = 0; u <= r; u += y.map.gridSize) {
							o(e, {
								x: 0,
								y: u
							}, {
					...
					value: function(e) {
						if (this.dataLoaded) {
							var t = new s.Container,
								...
								d = this.height,
								m = (this.terrain, f.getScreenDimensions().height);
							g.pixelRatio > 1 && (m *= 2);
							var u = d / m,
								h = new s.Graphics;
							...
							h.lineStyle(2 * u, 0, 1), o(h, b, x), o(h, x, v), o(h, v, y), o(h, y, b), h.position.y = d, h.scale.y = -1, t.addChild(h);
									...
									switch (S.beginFill(I.color, 1), z.type) {
										...
										case l.Type.Aabb:
											var D = p.mul(p.sub(z.max, z.min), .5),
												O = p.add(z.min, D);
											D = p.mul(D, A), S.drawRect(O.x - D.x, d - O.y - D.y, 2 * D.x, 2 * D.y)
									}
									S.endFill()
								}
							t.addChild(S);
							for (var E = new s.Container, L = 0; L < i.length; L++) {
								var B = i[L],
									F = new s.TextStyle({
										fontFamily: "Arial",
								...
								R.anchor = new s.Point(.5, .5), R.x = B.pos.x * this.height / u, R.y = B.pos.y * this.height / u, R.alpha = .75, E.addChild(R)
							}
							a.addChild(E), this.mapTexture ? this.mapTexture.resize(m, m) : this.mapTexture = s.RenderTexture.create(m, m, s.SCALE_MODES.LINEAR, 2), t.scale = new s.Point(m / d, m / d), e.render(t, this.mapTexture, !0), e.render(a, this.mapTexture, !1), t.destroy({
								children: !0,
								texture: !0,
								baseTexture: !0
							}), a.destroy({
					...
					value: function(e, t) {
						...
						for (var n = a.getPool(), r = 0, s = 2 & t, c = 0; c < n.length; c++) {
							var d = n[c];
							if (!(d.zIdx < r) && !(d.layer != t && !s || 1 == d.layer && s))
								for (var m = 0; m < d.surfaces.length; m++)
									for (var p = d.surfaces[m], u = 0; u < p.colliders.length; u++) {
										var h = l.intersectCircle(p.colliders[u], e, 1e-4);
										if (h) {
											r = d.zIdx, o = p.surface;
											break
										}
									}
						}
					...
					value: function(e, t, a) {
						...
						for (var r = this.display.water, c = this.buildingPool.getPool(), d = 0; d < c.length; d++) {
							var u = c[d];
							if (m.sameLayer(u.layer, t)) {
	...
	"5dFr": function(e, t, a) {
		...
		o.prototype = {
			...
			update: function(e, t, a, o, n, r, l) {
				...
				for (var E = 0; E < this.emotes.length; E++) {
					var L = this.emotes[E];
					if (L.alive) {
						var B = !1,
							F = h.create(0, 0),
							R = 0,
							j = c.getPlayerById(L.playerId);
						if (j && !j.netData.dead && (F = h.copy(j.pos), R = j.layer, B = !0), !B) {
							var N = r.getDeadBodyById(L.playerId);
						...
						if (B) {
							...
							L.isNew = !1, L.pos = F, L.lifeIn > 0 ? L.lifeIn -= e : L.life > 0 ? L.life -= e : L.lifeOut > 0 && (L.lifeOut -= e);
							var V = f.sameLayer(R, this.activePlayer.layer) ? 3 : R;
							l.addPIXIObj(L.container, k.World, V, 1e3, L.zIdx), L.alive = L.alive && L.lifeOut > 0
						} else L.alive = !1
					}
				}
				...
				for (var W = c.getTeamInfo(this.teamId), H = W.playerIds.length, K = 0; K < H; K++) {
							...
							if (X.hasOwnProperty(Q)) {
								...
								if ($.fadeIn -= e, $.life -= e, $.fadeOut -= $.life > 0 ? 0 : e, $.fadeOut > 0) {
									var se = $.pos,
										...
										ce = u.intersectRayAabb(p.pos, le, U.min, U.max),
										de = Math.atan2(le.y, -le.x) + .5 * Math.PI,
										me = p.pointToScreen(ce),
										pe = u.testCircleAabb(se, s.player.radius, U.min, U.max),
	...
	"6XNf": function(e, t, a) {
		...
		var i = {
			...
			"game-9mm": "9mm",
			"game-9mm-tooltip": "MP5, MAC-10, UMP9, Vector, M9, G18Cç”¨ã®å¼¾è–¬",
			"game-12gauge": "12 gauge",
			"game-12gauge-tooltip": "M870, SPAS-12, MP220, Saiga-12ç”¨ã®ã®å¼¾è–¬",
			"game-762mm": "7.62mm",
			"game-762mm-tooltip": "AK-47, SCAR-H, DP-28, Mosin-Nagant, SV-98, M39, OT-38ç”¨ã®å¼¾è–¬",
			"game-556mm": "5.56mm",
			"game-556mm-tooltip": "FAMAS, M416, Mk 12 SPR, M249ç”¨ã®å¼¾è–¬",
	...
	"8jco": function(e, t, a) {
		...
		var i = {
			...
			"game-9mm": "9Ð¼Ð¼",
			"game-9mm-tooltip": "ÐŸÐ°Ñ‚Ñ€Ð¾Ð½Ñ‹ Ð´Ð»Ñ M9, G18C, MP5, MAC-10, UMP9 Ð¸ Vector.",
			"game-12gauge": "12 ÐºÐ°Ð»Ð¸Ð±Ñ€",
			"game-12gauge-tooltip": "ÐŸÐ°Ñ‚Ñ€Ð¾Ð½Ñ‹ Ð´Ð»Ñ M870, SPAS-12, Ð¡Ð°Ð¹Ð³Ð°-12 Ð¸ MP220.",
			"game-762mm": "7.62Ð¼Ð¼",
			"game-762mm-tooltip": "ÐŸÐ°Ñ‚Ñ€Ð¾Ð½Ñ‹ Ð´Ð»Ñ AK-47, SCAR-H, M39, Ð’Ð¸Ð½Ñ‚Ð¾Ð²ÐºÐ° ÐœÐ¾ÑÐ¸Ð½Ð°, SV-98, OT-38 Ð¸ DP-28.",
			"game-556mm": "5.56Ð¼Ð¼",
			"game-556mm-tooltip": "ÐŸÐ°Ñ‚Ñ€Ð¾Ð½Ñ‹ Ð´Ð»Ñ FAMAS, M416, Mk 12 Ð¸ M249.",
	...
	Bk7F: function(e, t, a) {
		...
		function n(e) {
			...
			if ("structure" == t.type) {
				for (var a = [], i = 0; i < t.layers.length; i++) {
					var r = t.layers[i],
						s = o(r.ori),
						l = L.transform(n(r.type), r.pos, s, 1);
					a.push(L.toAabb(l))
				}
				var c = E.boundingAabb(a);
				return L.createAabb(c.min, c.max)
			}
			if ("building" == t.type) {
				...
				for (var p = 0; p < t.mapObjects.length; p++) {
					...
					if ("function" == typeof h && (h = h()), "" != h) {
						var g = o(u.ori),
							f = L.transform(n(h), u.pos, g, u.scale);
						d.push(L.toAabb(f))
					}
				}
				var b = E.boundingAabb(d);
				return L.createAabb(b.min, b.max)
			}
			return "decal" == t.type ? L.toAabb(t.collision) : (O(t.collision), t.collision)
		}
		...
		function p(e) {
			return c({
				...
				collision: L.createCircle(F.create(0, 0), 1.75),
				height: .5,
				collidable: !0,
				destructible: !0,
				health: 20,
		...
		function u(e) {
			return c({
				...
				collision: L.createAabbExtents(F.create(0, 0), F.create(3.5, 1)),
				height: .5,
				collidable: !0,
				destructible: !0,
				health: 75,
		...
		function h(e) {
			return c({
				...
				collision: L.createCircle(F.create(0, 0), 1.4),
				height: 10,
				collidable: !1,
				destructible: !0,
				health: 100,
		...
		function g(e) {
			return c({
				...
				collision: L.createAabbExtents(F.create(0, 0), F.create(2.25, 1.6)),
				height: .5,
				collidable: !0,
				destructible: !0,
				health: 75,
		...
		function b(e) {
			...
			return {
				...
				floor: {
					surfaces: [{
						type: "container",
						collision: [e.open ? L.createAabbExtents(F.create(0, 0), F.create(2.5, 11)) : L.createAabbExtents(F.create(0, 0), F.create(2.5, 8))]
					}],
					imgs: [{
				...
				ceiling: {
					scopeIn: [e.open ? L.createAabbExtents(F.create(0, 0), F.create(2.5, 5.75)) : L.createAabbExtents(F.create(0, 2.25), F.create(2.5, 5.5))],
					scopeOut: [e.open ? L.createAabbExtents(F.create(0, 0), F.create(2.5, 11)) : L.createAabbExtents(F.create(0, -.5), F.create(2.5, 8.75))],
					imgs: [{
		...
		function y(e) {
			return c({
				...
				collision: L.createAabbExtents(F.create(0, 0), F.create(2.25, 2.25)),
				height: .5,
				collidable: !0,
				destructible: !0,
				health: 75,
		...
		function x(e) {
			return c({
				...
				collision: L.createAabbExtents(F.create(0, .15), F.create(2.5, 1)),
				height: 10,
				collidable: !0,
				destructible: !0,
				health: 20,
		...
		function _(e) {
			return c({
				...
				collision: L.createAabbExtents(F.create(0, .15), F.create(2.5, 1.25)),
				height: .5,
				collidable: !0,
				destructible: !0,
				health: 75,
		...
		function w(e) {
			return c({
				...
				collision: L.createAabbExtents(F.create(0, .15), F.create(1.5, .6)),
				height: 10,
				collidable: !0,
				destructible: !0,
				health: 20,
		...
		function S(e) {
			return c({
				...
				collision: L.createAabbExtents(F.create(0, 0), F.create(1, 1)),
				height: .5,
				collidable: !0,
				destructible: !0,
		...
		function M(e) {
			return c({
				...
				collision: L.createCircle(F.create(0, 0), 1.5),
				height: .5,
				collidable: !0,
				destructible: !0,
				health: 50,
		...
		function T(e) {
			return c({
				...
				collision: L.createCircle(F.create(0, 0), 1.6),
				height: .5,
				collidable: !0,
				destructible: !0,
				health: 250,
		...
		function P(e) {
			return c({
				...
				collision: L.createCircle(F.create(0, .25), 1.18),
				height: .5,
				collidable: !0,
				destructible: !0,
				health: 100,
		...
		function C(e) {
			var t = {
				...
				collision: L.createAabbExtents(F.create(0, 0), F.copy(e.extents)),
				height: 10,
				isWall: !0,
				collidable: !0,
				destructible: !0,
		...
		function I(e) {
			return c({
				...
				map: {
					display: !0,
					shapes: [{
						collider: L.createAabbExtents(F.create(0, 0), F.create(7, 7)),
						color: 15181895
					}, {
						collider: L.createAabbExtents(F.create(0, -18.9), F.create(2, 12)),
						color: 6171907
					}]
				},
				terrain: {
				...
				floor: {
					surfaces: [{
						type: "shack",
						collision: [L.createAabbExtents(F.create(0, 0), F.create(7, 7)), L.createAabbExtents(F.create(0, -18.9), F.create(2, 12))]
					}],
					imgs: [{
				...
				ceiling: {
					scopeIn: [L.createAabbExtents(F.create(0, 0), F.create(6, 6))],
					scopeOut: [L.createAabbExtents(F.create(0, 0), F.create(6, 6))],
					vision: {
						width: 4
					},
					imgs: [{
		...
		function z(e) {
			return c({
				...
				collision: L.createAabbExtents(F.create(0, 0), F.create(.4, 2)),
				height: 10,
				collidable: !0,
				destructible: !0,
				isWindow: !0,
		...
		var D = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function(e) {
			...
			j = {
				...
				barrel_03: p({
					collision: L.createAabbExtents(F.create(0, 0), F.create(1.25, .5)),
					health: 20,
					img: {
				...
				bollard_01: {
					...
					collision: L.createCircle(F.create(0, 0), 1.25),
					height: .5,
					collidable: !0,
					destructible: !1,
					health: 300,
				...
				control_panel_01: S({
					collision: L.createAabbExtents(F.create(0, 0), F.create(2.25, 1.7)),
					button: {
						interactionRad: 1.75,
						useOnce: !0,
				...
				control_panel_03: S({
					collision: L.createAabbExtents(F.create(0, 0), F.create(1.25, 1.2)),
					health: 150,
					img: {
				...
				crate_03: y({
					health: 100,
					collision: L.createAabbExtents(F.create(0, 0), F.create(1.575, 1.575)),
				...
				crate_05: y({
					collision: L.createAabbExtents(F.create(0, 0), F.create(2, 2)),
					destructible: !1,
				...
				crate_06: y({
					collision: L.createAabbExtents(F.create(0, 0), F.create(2.25, 1.1)),
					destructible: !1,
					hitParticle: "greenChip",
					loot: [],
					map: {
				...
				fire_ext_01: {
					...
					collision: L.createCircle(F.create(.35, 0), 1),
					height: .5,
					collidable: !0,
					destructible: !0,
					createSmoke: !0,
				...
				oven_01: {
					...
					collision: L.createAabbExtents(F.create(0, .15), F.create(1.7, 1.3)),
					height: .5,
					collidable: !0,
					destructible: !0,
					explosion: "explosion_barrel",
				...
				refrigerator_01: {
					...
					collision: L.createAabbExtents(F.create(0, .15), F.create(1.7, 1.25)),
					height: .5,
					collidable: !0,
					destructible: !1,
					health: 100,
				...
				sandbags_01: {
					...
					collision: L.createAabbExtents(F.create(0, 0), F.create(3.1, 1.4)),
					height: .5,
					collidable: !0,
					destructible: !1,
					health: 150,
				...
				container_05: {
					...
					floor: {
						surfaces: [{
							type: "container",
							collision: [L.createAabbExtents(F.create(0, 0), F.create(0, 0))]
						}],
						imgs: [{
							sprite: "",
							scale: .5,
					...
					ceiling: {
						scopeIn: [L.createAabbExtents(F.create(0, 2.4), F.create(2.5, 5.75))],
						scopeOut: [L.createAabbExtents(F.create(0, 2.4), F.create(2.5, 5.75))],
						imgs: [{
				...
				silo_01: {
					...
					collision: L.createCircle(F.create(0, 0), 7.75),
					height: 10,
					collidable: !0,
					destructible: !1,
					health: 300,
				...
				stairs_01: {
					...
					collision: L.createAabbExtents(F.create(0, 0), F.create(2.5, 2)),
					height: .5,
					collidable: !1,
					destructible: !0,
					health: 100,
				...
				stand_01: {
					...
					collision: L.createAabbExtents(F.create(0, .15), F.create(1.25, 1.25)),
					height: .5,
					collidable: !0,
					destructible: !0,
					health: 75,
				...
				table_02: {
					...
					collision: L.createAabbExtents(F.create(0, 0), F.create(4.5, 2.5)),
					height: .5,
					collidable: !1,
					destructible: !0,
					health: 125,
				...
				tree_01: {
					...
					collision: L.createCircle(F.create(0, 0), 1.55),
					aabb: L.createAabbExtents(F.create(0, 0), F.create(5.75, 5.75)),
					height: 10,
					collidable: !0,
					destructible: !0,
					health: 175,
				...
				vat_01: {
					...
					collision: L.createCircle(F.create(0, 0), 2),
					height: .5,
					collidable: !0,
					destructible: !0,
					health: 250,
				...
				vat_02: {
					...
					collision: L.createCircle(F.create(0, 0), 3.1),
					height: .5,
					collidable: !0,
					destructible: !1,
					health: 1e3,
				...
				hedgehog_01: {
					...
					floor: {
						surfaces: [{
							type: "grass",
							collision: [L.createAabbExtents(F.create(0, 0), F.create(3, 3))]
						}],
						imgs: [{
					...
					ceiling: {
						scopeIn: [L.createAabbExtents(F.create(0, 0), F.create(0, 0))],
						scopeOut: [L.createAabbExtents(F.create(0, 0), F.create(0, 0))],
						imgs: []
					},
					mapObjects: [{
						type: "hedgehog_wall",
				...
				hut_wall_int_4: C({
					...
					hitParticle: "tanChip",
					img: m("img/map/map-wall-04.svg", 4608e3)
				}),
				hut_wall_int_5: C({
					material: "wood",
					extents: F.create(.5, 2.5),
					hitParticle: "tanChip",
					img: m("img/map/map-wall-05.svg", 4608e3)
				}),
				hut_wall_int_6: C({
					material: "wood",
					extents: F.create(.5, 3),
					hitParticle: "tanChip",
					img: m("img/map/map-wall-06.svg", 4608e3)
				}),
				hut_wall_int_12: C({
					material: "wood",
					extents: F.create(.5, 6),
					hitParticle: "tanChip",
					img: m("img/map/map-wall-12.svg", 4608e3)
				}),
				hut_wall_int_14: C({
					material: "wood",
					extents: F.create(.5, 7),
					hitParticle: "tanChip",
					img: m("img/map/map-wall-14.svg", 4608e3)
				}),
				...
				warehouse_01: function(e) {
					return c({
						...
						map: {
							display: !0,
							shapes: [{
								collider: L.createAabbExtents(F.create(27, 0), F.create(3, 12.25)),
								color: 10066329
							}, {
								collider: L.createAabbExtents(F.create(-27, 0), F.create(3, 12.25)),
								color: 10066329
							}, {
								collider: L.createAabbExtents(F.create(0, 0), F.create(24.5, 12.25)),
								color: 5915450
							}]
						},
						zIdx: 1,
						...
						floor: {
							surfaces: [{
								type: "warehouse",
								collision: [L.createAabbExtents(F.create(0, 0), F.create(32, 12.5))]
							}],
							imgs: [{
						...
						ceiling: {
							scopeIn: [L.createAabbExtents(F.create(0, 0), F.create(24.5, 12.25))],
							scopeOut: [L.createAabbExtents(F.create(0, 0), F.create(32, 12.5))],
							vision: {
								dist: 8,
								width: 5
							},
				...
				warehouse_02: function(e) {
					return c({
						...
						map: {
							display: !0,
							shapes: [{
								collider: L.createAabbExtents(F.create(25, 0), F.create(3, 12.25)),
								color: 10066329
							}, {
								collider: L.createAabbExtents(F.create(-25, 0), F.create(3, 12.25)),
								color: 10066329
							}, {
								collider: L.createAabbExtents(F.create(0, 0), F.create(22.5, 12.25)),
								color: 2240064
							}]
						},
						zIdx: 1,
						...
						floor: {
							surfaces: [{
								type: "warehouse",
								collision: [L.createAabbExtents(F.create(0, 0), F.create(27.5, 12.5))]
							}],
							imgs: [{
						...
						ceiling: {
							scopeIn: [L.createAabbExtents(F.create(0, 0), F.create(22, 12.25))],
							scopeOut: [L.createAabbExtents(F.create(0, 0), F.create(27.5, 12.5))],
							vision: {
								dist: 8,
								width: 5
							},
				...
				warehouse_complex_01: {
					...
					map: {
						display: !0,
						shapes: [{
							collider: L.createAabbExtents(F.create(26, 70.5), F.create(47, 7.5)),
							color: 5855577
						}, {
							collider: L.createAabbExtents(F.create(15.5, 52.5), F.create(57.5, 10.5)),
							color: 5855577
						}, {
							collider: L.createAabbExtents(F.create(33, 11), F.create(75, 31)),
							color: 5855577
						}, {
							collider: L.createAabbExtents(F.create(5, -30), F.create(47, 10)),
							color: 5855577
						}, {
							collider: L.createAabbExtents(F.create(-39.75, 11.25), F.create(2, 51)),
							color: 16109568
						}, {
							collider: L.createCircle(F.create(-39, 55), 1.25),
							color: 6310464
						}, {
							collider: L.createCircle(F.create(-39, 20.5), 1.25),
							color: 6310464
						}, {
							collider: L.createCircle(F.create(-39, 2), 1.25),
							color: 6310464
						}, {
							collider: L.createCircle(F.create(-39, -31.5), 1.25),
							color: 6310464
						}, {
							collider: L.createAabbExtents(F.create(-28, -30), F.create(2, 2)),
							color: 6697728
						}, {
							collider: L.createAabbExtents(F.create(-23, -33), F.create(2, 2)),
							color: 6697728
						}, {
							collider: L.createAabbExtents(F.create(7, 70), F.create(2, 2)),
							color: 6697728
						}, {
							collider: L.createAabbExtents(F.create(12, 72), F.create(2, 2)),
							color: 6697728
						}, {
							collider: L.createCircle(F.create(-26.5, 54.75), 1.75),
							color: 8026746
						}, {
							collider: L.createCircle(F.create(-23.5, 57), 1.75),
							color: 8026746
						}, {
							collider: L.createCircle(F.create(84, -15.5), 1.75),
							color: 8026746
						}, {
							collider: L.createCircle(F.create(40, -35), 1.5),
							color: 8026746
						}, {
							collider: L.createCircle(F.create(65, 61), 1.5),
							color: 8026746
						}, {
							collider: L.createAabbExtents(F.create(44.5, -25), F.create(1.4, 3.1)),
							color: 13278307
						}, {
							collider: L.createAabbExtents(F.create(58, 47.5), F.create(1.4, 3.1)),
							color: 13278307
						}]
					},
					terrain: {
					...
					mapObstacleBounds: [L.createAabbExtents(F.create(26, 70.5), F.create(47, 7.5)), L.createAabbExtents(F.create(15.5, 52.5), F.create(57.5, 10.5)), L.createAabbExtents(F.create(33, 11), F.create(75, 31)), L.createAabbExtents(F.create(5, -30), F.create(47, 10))],
					floor: {
						surfaces: [{
							type: "asphalt",
							collision: [L.createAabbExtents(F.create(26, 70.5), F.create(47, 7.5)), L.createAabbExtents(F.create(15.5, 52.5), F.create(57.5, 10.5)), L.createAabbExtents(F.create(33, 11), F.create(75, 31)), L.createAabbExtents(F.create(5, -30), F.create(47, 10))]
						}],
						imgs: [{
				...
				shack_01: {
					...
					floor: {
						surfaces: [{
							type: "shack",
							collision: [L.createAabbExtents(F.create(0, .9), F.create(5.6, 3.5)), L.createAabbExtents(F.create(3.75, -4), F.create(2.25, 1.5))]
						}],
						imgs: [{
					...
					ceiling: {
						scopeIn: [L.createAabbExtents(F.create(0, .9), F.create(5.6, 3.5))],
						scopeOut: [L.createAabbExtents(F.create(0, .8), F.create(5.9, 3.8))],
						vision: {
							width: 4
						},
						imgs: [{
				...
				shack_02: {
					...
					floor: {
						surfaces: [{
							type: "shack",
							collision: [L.createAabbExtents(F.create(0, 1), F.create(5, 4)), L.createAabbExtents(F.create(3.75, -4), F.create(2.25, 1.5))]
						}],
						imgs: [{
					...
					ceiling: {
						scopeIn: [L.createAabbExtents(F.create(0, 1), F.create(4.75, 3.75))],
						scopeOut: [L.createAabbExtents(F.create(0, 1), F.create(0, 0))],
						vision: {
							width: 4
						},
						imgs: [{
				...
				outhouse_01: {
					...
					floor: {
						surfaces: [{
							type: "shack",
							collision: [L.createAabbExtents(F.create(0, 0), F.create(3.8, 5))]
						}],
						imgs: [{
					...
					ceiling: {
						scopeIn: [L.createAabbExtents(F.create(0, 1.45), F.create(3.6, 3.2))],
						scopeOut: [L.createAabbExtents(F.create(0, 1.4), F.create(3.8, 3.4))],
						imgs: [{
				...
				panicroom_01: {
					...
					floor: {
						surfaces: [{
							type: "container",
							collision: [L.createAabbExtents(F.create(0, 0), F.create(4.5, 6))]
						}],
						imgs: [{
					...
					ceiling: {
						scopeIn: [L.createAabbExtents(F.create(0, 0), F.create(4.5, 6))],
						scopeOut: [L.createAabbExtents(F.create(0, 0), F.create(4.5, 6))],
						imgs: [{
				...
				barn_01: {
					...
					map: {
						display: !0,
						shapes: [{
							collider: L.createAabbExtents(F.create(0, 12), F.create(5, 2)),
							color: 12300935
						}, {
							collider: L.createAabbExtents(F.create(0, -2), F.create(24.5, 12.8)),
							color: 3816739
						}]
					},
					terrain: {
					...
					floor: {
						surfaces: [{
							type: "house",
							collision: [L.createAabbExtents(F.create(0, -2), F.create(25, 13.2)), L.createAabbExtents(F.create(0, 12), F.create(5.5, 2.5))]
						}],
						imgs: [{
					...
					ceiling: {
						scopeIn: [L.createAabbExtents(F.create(0, -2), F.create(24.5, 12.8)), L.createAabbExtents(F.create(0, 12), F.create(5.5, 2.5))],
						scopeOut: [L.createAabbExtents(F.create(0, -14.5), F.create(5.5, 4)), L.createAabbExtents(F.create(0, 14.5), F.create(5.5, 4))],
						vision: {
							dist: 5.5,
							width: 2.75,
							linger: .5,
				...
				bank_01: {
					...
					map: {
						display: !0,
						shapes: [{
							collider: L.createAabbExtents(F.create(-16, 7), F.create(10.75, 11)),
							color: 7820585
						}, {
							collider: L.createAabbExtents(F.create(6, 0), F.create(11.5, 18.25)),
							color: 9989427
						}, {
							collider: L.createAabbExtents(F.create(22, 4), F.create(4.5, 7.5)),
							color: 7820585
						}]
					},
					terrain: {
					...
					floor: {
						surfaces: [{
							type: "tile",
							collision: [L.createAabbExtents(F.create(6, -1), F.create(11.25, 18.25)), L.createAabbExtents(F.create(21.5, 4), F.create(4.75, 7.25))]
						}],
						imgs: [{
					...
					ceiling: {
						scopeIn: [L.createAabbExtents(F.create(6, -1), F.create(11.25, 18.25)), L.createAabbExtents(F.create(21.5, 4), F.create(4.75, 7.25)), L.createAabbExtents(F.create(-16, 6), F.create(10.25, 11))],
						scopeOut: [L.createAabbExtents(F.create(6, 1.25), F.create(15.25, 20))],
						vision: {
							dist: 5.5,
							width: 2.75,
							linger: .5,
				...
				vault_01: {
					...
					floor: {
						surfaces: [{
							type: "container",
							collision: [L.createAabbExtents(F.create(-3.5, 0), F.create(10, 10.5))]
						}],
						imgs: [{
					...
					ceiling: {
						scopeIn: [L.createAabbExtents(F.create(-3.5, 0), F.create(9.25, 10.5))],
						scopeOut: [L.createAabbExtents(F.create(-3.5, 0), F.create(10, 10.5))],
						vision: {
							dist: 7.25,
							width: 2.75,
							linger: .5,
				...
				police_01: {
					...
					map: {
						display: !0,
						shapes: [{
							collider: L.createAabbExtents(F.create(-21, -8), F.create(21.25, 14)),
							color: 5855577
						}, {
							collider: L.createAabbExtents(F.create(-24.5, 8.5), F.create(17.75, 9.75)),
							color: 3355970
						}, {
							collider: L.createAabbExtents(F.create(-3.5, 12), F.create(3.5, 6.25)),
							color: 4278620
						}, {
							collider: L.createAabbExtents(F.create(10.35, 0), F.create(10.5, 22)),
							color: 3355970
						}, {
							collider: L.createAabbExtents(F.create(31.25, 12.5), F.create(10.75, 9.5)),
							color: 3355970
						}, {
							collider: L.createAabbExtents(F.create(-3.5, 2.5), F.create(2.25, 2.25)),
							color: 6310464
						}, {
							collider: L.createCircle(F.create(-30.5, -18), 1.5),
							color: 8026746
						}, {
							collider: L.createCircle(F.create(-20.5, -10.5), 1.5),
							color: 8026746
						}, {
							collider: L.createAabbExtents(F.create(-38.5, -7), F.create(1.4, 3.1)),
							color: 13278307
						}, {
							collider: L.createAabbExtents(F.create(-7.5, -19.5), F.create(3.1, 1.4)),
							color: 13278307
						}]
					},
					terrain: {
					...
					floor: {
						surfaces: [{
							type: "tile",
							collision: [L.createAabbExtents(F.create(-24.5, 8.5), F.create(17.75, 9.75)), L.createAabbExtents(F.create(-3.5, 12), F.create(3.5, 6.25)), L.createAabbExtents(F.create(10.35, 0), F.create(10.5, 22)), L.createAabbExtents(F.create(31.25, 12.5), F.create(10.75, 9.5))]
						}, {
							type: "asphalt",
							collision: [L.createAabbExtents(F.create(-21.5, -13), F.create(21, 11.5)), L.createAabbExtents(F.create(-3.5, 2), F.create(3, 3.5))]
						}],
						imgs: [{
					...
					ceiling: {
						scopeIn: [L.createAabbExtents(F.create(-24.5, 8.5), F.create(17.75, 9.75)), L.createAabbExtents(F.create(-3.5, 12), F.create(3.5, 6.25)), L.createAabbExtents(F.create(10.35, 0), F.create(10.5, 22)), L.createAabbExtents(F.create(31.25, 12.5), F.create(10.75, 9.5))],
						scopeOut: [L.createAabbExtents(F.create(12, 0), F.create(12.75, 26))],
						vision: {
							dist: 5.5,
							width: 2.75,
							linger: .5,
				...
				house_red_01: {
					...
					floor: {
						surfaces: [{
							type: "house",
							collision: [L.createAabbExtents(F.create(0, 0), F.create(14.5, 13))]
						}],
						imgs: [{
					...
					ceiling: {
						scopeIn: [L.createAabbExtents(F.create(0, 0), F.create(14.5, 13))],
						scopeOut: [L.createAabbExtents(F.create(0, 0), F.create(16.5, 15))],
						vision: {
							dist: 5.5,
							width: 2.75,
							linger: .5,
				...
				saferoom_01: {
					...
					floor: {
						surfaces: [{
							type: "container",
							collision: [L.createAabbExtents(F.create(0, 0), F.create(6, 4))]
						}],
						imgs: [{
					...
					ceiling: {
						scopeIn: [L.createAabbExtents(F.create(0, 0), F.create(5, 3))],
						scopeOut: [L.createAabbExtents(F.create(0, 0), F.create(5, 3))],
						imgs: [{
				...
				mansion_01: {
					...
					map: {
						display: !0,
						shapes: [{
							collider: L.createAabbExtents(F.create(-1.5, 20.5), F.create(12.5, 4.5)),
							color: 8671554
						}, {
							collider: L.createAabbExtents(F.create(-2, -23), F.create(3, 2.5)),
							color: 8671554
						}, {
							collider: L.createAabbExtents(F.create(-20.5, -22.5), F.create(10, 2)),
							color: 7750457
						}, {
							collider: L.createAabbExtents(F.create(28, 1.5), F.create(3.75, 3)),
							color: 7237230
						}, {
							collider: L.createAabbExtents(F.create(-3.5, -2), F.create(28, 18.5)),
							color: 6175023
						}]
					},
					terrain: {
					...
					floor: {
						surfaces: [{
							type: "tile",
							collision: [L.createAabbExtents(F.create(-3.5, -2), F.create(28, 18.5)), L.createAabbExtents(F.create(-1.5, 20.5), F.create(12.5, 4.5)), L.createAabbExtents(F.create(0, 0), F.create(20, 20))]
						}, {
							type: "asphalt",
							collision: [L.createAabbExtents(F.create(-21, -17), F.create(11, 8)), L.createAabbExtents(F.create(-23, -6), F.create(8, 3)), L.createAabbExtents(F.create(-2, -24), F.create(2, 3)), L.createAabbExtents(F.create(28, 1.5), F.create(3, 3))]
						}, {
							type: "grass",
							collision: [L.createAabbExtents(F.create(-2, 4), F.create(5, 5))]
						}, {
							type: "house",
							collision: [L.createAabbExtents(F.create(1, 13), F.create(2, 3.25))]
						}],
						imgs: [{
					...
					ceiling: {
						scopeIn: [L.createAabbExtents(F.create(-15, -22.4), F.create(17, 2.2)), L.createAabbExtents(F.create(-3.5, -2), F.create(28, 18.5)), L.createAabbExtents(F.create(-1.5, 20.6), F.create(12, 4.2))],
						scopeOut: [L.createAabbExtents(F.create(-15, -24.4), F.create(21, 4.2)), L.createAabbExtents(F.create(-3.5, -2), F.create(28, 18.5)), L.createAabbExtents(F.create(-9, 23.1), F.create(5, 6.7))],
						vision: {
							dist: 5.5,
							width: 2.75,
							linger: .5,
				...
				mansion_cellar_01: {
					...
					floor: {
						surfaces: [{
							type: "brick",
							collision: [L.createAabbExtents(F.create(18, 3), F.create(7, 13)), L.createAabbExtents(F.create(5, 0), F.create(6, 10))]
						}],
						imgs: [{
					...
					ceiling: {
						scopeIn: [L.createAabbExtents(F.create(18, 3), F.create(7, 13)), L.createAabbExtents(F.create(5, 1.5), F.create(6, 12))],
						scopeOut: [L.createAabbExtents(F.create(18, 3), F.create(7, 13)), L.createAabbExtents(F.create(5, 1.5), F.create(6, 12))],
						vision: {
							dist: 5.5,
							width: 2.75,
							linger: .5,
				...
				mansion_structure_01: {
					...
					stairs: [{
						collision: L.createAabbExtents(F.create(28, 1.5), F.create(3, 2.55)),
						downDir: F.create(-1, 0),
						noCeilingReveal: !0
					}, {
						collision: L.createAabbExtents(F.create(1, 13.5), F.create(2, 3.5)),
						downDir: F.create(0, -1)
					}],
					mask: [L.createAabbExtents(F.create(10, -.1), F.create(15, 10.1)), L.createAabbExtents(F.create(17.5, 13.5), F.create(7.5, 3.5))]
				},
				bunker_egg_01: {
					type: "building",
					map: {
					...
					floor: {
						surfaces: [{
							type: "container",
							collision: [L.createAabbExtents(F.create(0, 7.75), F.create(2, 3.25))]
						}],
						imgs: [{
				...
				bunker_egg_sublevel_01: {
					...
					floor: {
						surfaces: [{
							type: "bunker",
							collision: [L.createAabbExtents(F.create(0, -4.5), F.create(10, 9))]
						}],
						imgs: [{
					...
					ceiling: {
						scopeIn: [L.createAabbExtents(F.create(0, -4.5), F.create(10, 9))],
						scopeOut: [L.createAabbExtents(F.create(0, -4.5), F.create(10, 9))],
						imgs: [{
				...
				bunker_structure_01: {
					...
					mapObstacleBounds: [L.createAabbExtents(F.create(0, 5), F.create(7, 12))],
					layers: [{
						type: "bunker_egg_01",
						pos: F.create(0, 0),
						ori: 0
					...
					stairs: [{
						collision: L.createAabbExtents(F.create(0, 8.4), F.create(2, 2.6)),
						downDir: F.create(0, -1)
					}],
					mask: [L.createAabbExtents(F.create(0, -3.7), F.create(10, 9.5))]
				},
				bunker_hydra_01: {
					type: "building",
					map: {
						display: !0,
						shapes: [{
							collider: L.createAabbExtents(F.create(20.25, 3.5), F.create(6.25, 5.5)),
							color: 2894892
						}, {
							collider: L.createAabbExtents(F.create(32.25, 3.5), F.create(6.75, 9.25)),
							color: 3815994
						}]
					},
					terrain: {
					...
					floor: {
						surfaces: [{
							type: "tile",
							collision: [L.createAabbExtents(F.create(20.25, 3.5), F.create(6.25, 5.5)), L.createAabbExtents(F.create(32.25, 3.5), F.create(6.75, 9.25))]
						}, {
							type: "container",
							collision: [L.createAabbExtents(F.create(16.25, 3.5), F.create(3.25, 2)), L.createAabbExtents(F.create(-16.5, -90.75), F.create(2, 3.25)), L.createAabbExtents(F.create(40, -50.5), F.create(2, 3.25))]
						}],
						imgs: [{
					...
					ceiling: {
						scopeIn: [L.createAabbExtents(F.create(19.25, 3.5), F.create(6.25, 5.5)), L.createAabbExtents(F.create(32.25, 3.5), F.create(6.75, 9.25))],
						scopeOut: [L.createAabbExtents(F.create(19.25, 3.5), F.create(6.25, 5.5)), L.createAabbExtents(F.create(32.25, 3.5), F.create(6.75, 9.25))],
						imgs: [{
				...
				bunker_hydra_sublevel_01: {
					...
					floor: {
						surfaces: [{
							type: "bunker",
							collision: [L.createAabbExtents(F.create(3.5, 3), F.create(9.5, 9))]
						}, {
							type: "tile",
							collision: [L.createAabbExtents(F.create(-15.5, -79.5), F.create(3, 8)), L.createAabbExtents(F.create(40.5, -62), F.create(9.5, 8))]
						}],
						imgs: [{
					...
					ceiling: {
						scopeIn: [L.createAabbExtents(F.create(3.5, 2.25), F.create(10, 10)), L.createAabbExtents(F.create(-15, -77), F.create(5.5, 10.5)), L.createAabbExtents(F.create(38, -62), F.create(11.5, 8))],
						scopeOut: [L.createAabbExtents(F.create(3.5, 2.25), F.create(10, 10)), L.createAabbExtents(F.create(-15, -77), F.create(5.5, 10.5)), L.createAabbExtents(F.create(38, -62), F.create(11.5, 8))],
						imgs: [{
				...
				bunker_hydra_compartment_01: {
					...
					floor: {
						surfaces: [{
							type: "tile",
							collision: [L.createAabbExtents(F.create(0, 1.5), F.create(9.5, 12.5))]
						}],
						imgs: [{
					...
					ceiling: {
						scopeIn: [L.createAabbExtents(F.create(0, 1.25), F.create(10, 10))],
						scopeOut: [L.createAabbExtents(F.create(0, 1.25), F.create(10, 10))],
						imgs: [{
				...
				bunker_hydra_compartment_02: {
					...
					floor: {
						surfaces: [{
							type: "tile",
							collision: [L.createAabbExtents(F.create(-2.5, 16), F.create(22, 4)), L.createAabbExtents(F.create(-2.5, 9.5), F.create(6, 2.5)), L.createAabbExtents(F.create(0, -4.5), F.create(25, 17))]
						}],
						imgs: [{
					...
					ceiling: {
						scopeIn: [L.createAabbExtents(F.create(-2, 3), F.create(22.5, 19.5))],
						scopeOut: [L.createAabbExtents(F.create(-2, 3), F.create(22.5, 19.5))],
						imgs: [{
				...
				bunker_hydra_compartment_03: {
					...
					floor: {
						surfaces: [{
							type: "bunker",
							collision: [L.createAabbExtents(F.create(0, 2), F.create(9, 8.75))]
						}],
						imgs: [{
					...
					ceiling: {
						scopeIn: [L.createAabbExtents(F.create(0, .75), F.create(10, 7.75))],
						scopeOut: [L.createAabbExtents(F.create(0, .75), F.create(10, 7.75))],
						imgs: [{
				...
				bunker_structure_02: {
					...
					mapObstacleBounds: [L.createAabbExtents(F.create(25.5, 3.5), F.create(16, 11.5)), L.createAabbExtents(F.create(-16.5, -89.5), F.create(7, 7.5)), L.createAabbExtents(F.create(40, -47.25), F.create(6.5, 7.25)), L.createAabbExtents(F.create(-5.75, -38.5), F.create(3, 3))],
					layers: [{
					...
					stairs: [{
						collision: L.createAabbExtents(F.create(16.4, 3.5), F.create(2.6, 2)),
						downDir: F.create(-1, 0)
					}, {
						collision: L.createAabbExtents(F.create(-16.5, -90.4), F.create(2, 3.1)),
						downDir: F.create(0, 1)
					}, {
						collision: L.createAabbExtents(F.create(40, -50.5), F.create(2, 3.1)),
						downDir: F.create(0, -1)
					}],
					mask: [L.createAabbExtents(F.create(3.5, -7.2), F.create(10.5, 20)), L.createAabbExtents(F.create(-15, -79.75), F.create(5, 8.5)), L.createAabbExtents(F.create(39, -61.85), F.create(12, 9)), L.createAabbExtents(F.create(3.5, -49.2), F.create(23.5, 22)), L.createAabbExtents(F.create(10.5, -76.7), F.create(10, 5.5))]
				},
				bunker_storm_01: {
					type: "building",
					map: {
						display: !0,
						shapes: [{
							collider: L.createAabbExtents(F.create(0, 10), F.create(3.6, 5.8)),
							color: 6707790
						}]
					},
					terrain: {
					...
					floor: {
						surfaces: [{
							...
							type: "shack",
							collision: [L.createAabbExtents(F.create(0, 13.5), F.create(3.75, 2.5)), L.createAabbExtents(F.create(5, 13.75), F.create(1.25, 2.25))]
						}],
						imgs: [{
					...
					ceiling: {
						scopeIn: [L.createAabbExtents(F.create(0, 10), F.create(3.5, 5.6))],
						scopeOut: [L.createAabbExtents(F.create(0, 10), F.create(3.8, 5.9))],
						vision: {
							dist: 5,
							width: 2.75,
							linger: .5,
				...
				bunker_storm_sublevel_01: {
					...
					floor: {
						surfaces: [{
							type: "bunker",
							collision: [L.createAabbExtents(F.create(1, -4.4), F.create(10.5, 9))]
						}, {
							type: "tile",
							collision: [L.createAabbExtents(F.create(19, -5.5), F.create(7.5, 8))]
						}],
						imgs: [{
					...
					ceiling: {
						scopeIn: [L.createAabbExtents(F.create(8.5, -4.5), F.create(18, 9.1))],
						scopeOut: [L.createAabbExtents(F.create(8.5, -4.5), F.create(18, 9.1))],
						imgs: [{
				...
				bunker_structure_03: {
					...
					mapObstacleBounds: [L.createAabbExtents(F.create(1, 6), F.create(7, 13.5))],
					layers: [{
					...
					mask: [L.createAabbExtents(F.create(8.5, -3.7), F.create(18, 9.5))]
				},
				bunker_conch_01: {
					type: "building",
					map: {
						display: !0,
						shapes: [{
							collider: L.createAabbExtents(F.create(20, 3.35), F.create(5.5, 2.5)),
							color: 2703694
						}, {
							collider: L.createAabbExtents(F.create(46.5, -32.55), F.create(5.5, 2.5)),
							color: 2703694
						}]
					},
					terrain: {
					...
					floor: {
						surfaces: [{
							type: "container",
							collision: [L.createAabbExtents(F.create(16.25, 3.5), F.create(3.25, 2)), L.createAabbExtents(F.create(44.25, -32.5), F.create(3.25, 2)), L.createAabbExtents(F.create(22, 3.35), F.create(8, 2.5)), L.createAabbExtents(F.create(50.5, -32.55), F.create(8, 2.5))]
						}],
						imgs: [{
					...
					ceiling: {
						scopeIn: [L.createAabbExtents(F.create(19, 3.35), F.create(5.5, 2.5)), L.createAabbExtents(F.create(47.5, -32.55), F.create(5.5, 2.5))],
						scopeOut: [L.createAabbExtents(F.create(22, 3.35), F.create(8, 2.5)), L.createAabbExtents(F.create(50.5, -32.55), F.create(8, 2.5))],
						imgs: [{
				...
				bunker_conch_sublevel_01: {
					...
					floor: {
						surfaces: [{
							type: "tile",
							collision: [L.createAabbExtents(F.create(1, 4), F.create(12.5, 3.5)), L.createAabbExtents(F.create(28, -30), F.create(13.5, 4.5))]
						}],
						imgs: [{
					...
					ceiling: {
						scopeIn: [L.createAabbExtents(F.create(1, 3.5), F.create(12.5, 5)), L.createAabbExtents(F.create(26.75, -30), F.create(14.75, 4.5))],
						scopeOut: [L.createAabbExtents(F.create(1, 3.5), F.create(12.5, 5)), L.createAabbExtents(F.create(26.75, -30), F.create(14.75, 4.5))],
						imgs: [{
				...
				bunker_conch_compartment_01: {
					...
					floor: {
						surfaces: [{
							type: "water",
							collision: [L.createAabbExtents(F.create(1, -2.5), F.create(15, 15.5))]
						}],
						imgs: [{
					...
					ceiling: {
						scopeIn: [L.createAabbExtents(F.create(-1.5, -1), F.create(12.5, 12)), L.createAabbExtents(F.create(9.5, -14.5), F.create(4, 2.5))],
						scopeOut: [L.createAabbExtents(F.create(-1.5, -1), F.create(12.5, 12)), L.createAabbExtents(F.create(9.5, -14.5), F.create(4, 2.5))],
						imgs: [{
				...
				bunker_structure_04: {
					...
					mapObstacleBounds: [L.createAabbExtents(F.create(21, 3.5), F.create(9.5, 8)), L.createAabbExtents(F.create(48, -32.5), F.create(10, 8))],
					layers: [{
					...
					stairs: [{
						collision: L.createAabbExtents(F.create(16.9, 3.5), F.create(2.6, 2)),
						downDir: F.create(-1, 0)
					}, {
						collision: L.createAabbExtents(F.create(44.9, -32.5), F.create(2.6, 2)),
						downDir: F.create(-1, 0)
					}],
					mask: [L.createAabbExtents(F.create(3.5, -7.2), F.create(10.7, 20)), L.createAabbExtents(F.create(37.25, -32), F.create(5, 5))]
				},
				...
				loot_tier_1: {
					type: "loot_spawner",
					collision: L.createCircle(F.create(0, 0), 3),
					tier: "tier_world",
					terrain: {
						grass: !0,
						beach: !0
				...
				decal_barrel_explosion: {
					type: "decal",
					collision: L.createCircle(F.create(0, 0), 1),
					height: 0,
					img: {
				...
				decal_pipes_01: {
					type: "decal",
					collision: L.createAabbExtents(F.create(0, 0), F.create(1, 4.5)),
					height: 1,
					img: {
				...
				decal_pipes_02: {
					type: "decal",
					collision: L.createAabbExtents(F.create(0, 0), F.create(4, 3)),
					height: 1,
					img: {
				...
				decal_pipes_03: {
					type: "decal",
					collision: L.createAabbExtents(F.create(0, 0), F.create(10.5, 4)),
					height: 1,
					img: {
				...
				decal_pipes_04: {
					type: "decal",
					collision: L.createAabbExtents(F.create(0, 0), F.create(1, 5.5)),
					height: 1,
					img: {
	...
	BkwK: function(e, t, a) {
		...
		var i = {
			...
			"game-9mm": "9mm",
			"game-9mm-tooltip": "M9, G18C, MP5, MAC-10, UMP9, Vector íƒ„ì•½.",
			"game-12gauge": "12 ê²Œì´ì§€",
			"game-12gauge-tooltip": "M870, SPAS-12, Saiga-12, MP220 íƒ„ì•½.",
			"game-762mm": "7.62mm",
			"game-762mm-tooltip": "AK-47, SCAR-H, M39, Mosin-Nagant, SV-98, OT-38, DP-28 íƒ„ì•½.",
			"game-556mm": "5.56mm",
			"game-556mm-tooltip": "FAMAS, M416, Mk 12, M249 íƒ„ì•½.",
				...
				return o(e, [{
					...
					value: function(e, t, a, i, o, n) {
						...
						if (p && !h && (t.deadObstacleIds.push(this.__id), this.exploded = !0, this.smokeEmitter && (this.smokeEmitter.stop(), this.smokeEmitter = null), !g)) {
							for (var E = r.toAabb(this.collider), L = d.mul(d.sub(E.max, E.min), .5), B = d.add(E.min, L), F = Math.floor(c.random(5, 11)), R = 0; R < F; R++) {
						...
						if (this.smokeEmitter && (this.smokeEmitter.pos = d.copy(this.pos)), this.sprite.visible) {
							var q = this.dead ? 5 : this.sprite.zIdx,
								V = this.__id,
								G = this.layer;
							!this.dead && q >= 50 && 0 == this.layer && 0 == o.layer && (q += 100, G |= 2), n.addPIXIObj(this.sprite, u.World, G, q, V), this.isDoor && this.door.casingSprite && n.addPIXIObj(this.door.casingSprite, u.World, G, q + this.door.casingSprite.zIdx, V)
						}
						this.isNew = !1
					}
				}, {
	...
	FyxX: function(e, t, a) {
		...
		var o = function() {
					...
					value: function(e, t, a, i) {
						...
						if (this.type = e.type, this.pos = l.copy(e.pos), this.rot = s.oriToRad(e.ori), this.scale = e.scale, this.layer = e.layer, this.collider = r.transform(o.collision, this.pos, this.rot, this.scale), this.imgScale = o.img.scale, a) {
							...
							if (this.sprite.texture = n.Texture.fromImage(c.sprite), this.sprite.tint = c.tint, this.sprite.alpha = 1, this.sprite.visible = !0, this.isNew = !0, this.spriteAlpha = c.alpha, this.inWater = !1, o.height < .25) {
								var d = i.map.getGroundSurface(this.pos, this.layer);
								this.inWater = "water" == d
							}
							i.renderer.addPIXIObj(this.sprite, m.Decal, this.layer, o.img.zIdx, this.__id)
						}
					}
				}]), e
			}(),
			u = function() {
				function e() {
					i(this, e), this.decalPool = new c.Pool(p)
				}
				return o(e, [{
					key: "update",
					value: function(e, t, a) {
	...
	Jr6A: function(e, t, a) {
		...
		function u() {
			return p() && 375 == screen.width && 812 == screen.height
		}
		...
		function b() {
			...
			if (p()) {
				if (e = screen.width, t = screen.height, g()) {
					var a = t;
					t = e, e = a
				}
				u() && (g() ? e -= 88 : t -= 88)
		...
		function k(e, t, a) {
			...
			! function i(o) {
				...
				if (o.length > 0) {
					var r = o.shift();
					x() && console.log("Joining game", r, t.zone), e.tryJoinGame(t.data, r, n)
				} else a()
			}(r)
		}
		var _ = a("juYr"),
			w = a("yp2f"),
			S = a("zinx"),
			M = (a("85i3"), document.createElement("canvas"));
		e.exports = {
	...
	KdTN: function(e, t, a) {
		...
		var i = {
			...
			"game-9mm": "9mm",
			"game-9mm-tooltip": "Munition fÃ¼r M9, G18C, MP5, MAC-10, UMP9 und Vector.",
			"game-12gauge": "12er Kaliber",
			"game-12gauge-tooltip": "Munition fÃ¼r M870, SPAS-12, Saiga-12 und MP220.",
			"game-762mm": "7.62mm",
			"game-762mm-tooltip": "Munition fÃ¼r AK-47, SCAR-H, M39, Mosin-Nagant, SV-98, OT-38 und DP-28.",
			"game-556mm": "5.56mm",
			"game-556mm-tooltip": "Munition fÃ¼r FAMAS, M416, Mk 12 und M249.",
	...
	MWDq: function(e, t, a) {
		...
		n.prototype = {
						...
						switch (z.type) {
							case p.Reload:
								if ("" != z.item) {
									...
									E = this.localization.translate("game-reloading"), B = R.sound.reload, F = "reload" == R.caseTiming
								}
								break;
							case p.UseItem:
								if ("" != z.item) {
									var j = m.items[z.item];
									E = this.localization.translate("game-using"), L = this.localization.translate("game-" + z.item), B = j.sound.use
								}
								break;
							case p.Revive:
								var N = r.getPlayerInfo(z.targetId).name;
								E = this.localization.translate("game-reviving"), L = _.downed ? "" : N
						}
						if ("" == E && "" == L || ("svo" == this.localization.translate("word-order") ? (O += E || "", O += L ? " " + L : "") : "sov" == this.localization.translate("word-order") && (O += L ? L + " " : "", O += E ? " " + E : ""), this.pieTimer.init(function() {
							...
							for (var q = m.items[z.item], V = 0; V < q.maxClip; V++) {
								var G = V % 2 == 0 ? -1 : 1,
									U = Math.PI + Math.PI / 4 * G;
								w.createCasingParticle(z.item, U, t.pos, t.dir, t.netData.layer, this.particleBarn)
							}
					}
				}
								...
								if ($.indicators.hasOwnProperty(ce)) {
									...
									if (!ae || de.displayAll) {
										var ue = ie.pos,
											...
											ge = d.intersectRayAabb(s.pos, he, H.min, H.max),
											fe = Math.atan2(he.y, -he.x) + .5 * Math.PI,
											be = s.pointToScreen(ge),
											ye = d.testCircleAabb(ue, m.player.radius, H.min, H.max);
										if (!ie.dead && !ye) {
											var xe = 32,
			...
			showKill: function(e, t, a, i) {
				...
				}, 6e3), i || this.updatePlayerKills(e.kills)
			},
			...
			showStats: function(e, t) {
				...
				if (e.teamMode = e.teamMode || 1, e.spectating = e.spectating || !1, e.gameOver = e.gameOver || !1, e.stats = e.stats || {
					...
					this.statsInfoBox.children().each(function(e, t) {
						var a = l(t);
						a.css("opacity", 0), a.delay(i + S + (_ + e) * w).animate({
							opacity: 1
						}, 500, function() {
						...
						var a = l(t);
						a.hide(), a.delay(i + S + (_ + e) * w).fadeIn(500), _++
			...
			setSpectatedPlayer: function(e, t) {
				t = k.htmlEscape(t), this.spectatedPlayerId != e && (this.spectatedPlayerText.find("#spectate-player").html(t), this.spectatedPlayerName = t, this.spectatedPlayerId = e, this.curAction = {
					type: p.None
				})
			},
			...
			displayMapLarge: function(e) {
				...
				t += ", .js-ui-map-hidden", l(2 == this.visibilityMode ? ".js-ui-hud-show" : t).css("display", this.bigmapDisplayed ? "none" : "block"), l(".js-ui-map-show").css("display", this.bigmapDisplayed ? "block" : "none"), this.updateSpectatorCountDisplay(!0), this.redraw(this.game.camera)
			},
		...
		var n = function() {
			...
			g = function() {
				...
				return n(e, [{
					...
					value: function(e, t, a, i) {
						var o = this;
						if (this.type = e.type, this.pos = d.copy(e.pos), this.rot = l.oriToRad(e.ori), this.scale = 1, this.layer = e.layer, this.ceilingDead = e.ceilingDead, a) {
							var n = l.Defs[e.type];
							...
							var c = function(e) {
								var t = e.pos || d.create(0, 0),
									...
									i = o.allocSprite();
								return i.texture = r.Texture.fromImage(e.sprite), i.tint = e.tint, i.posOffset = d.rotate(t, o.rot), i.rotOffset = a, i.imgAlpha = e.alpha, i.alpha = i.imgAlpha, i.defScale = e.scale, i.visible = !0, i
							};
							this.bounds = s.transform(l.getBoundingCollider(this.type), this.pos, this.rot, this.scale), this.zIdx = n.zIdx || 0, this.surfaces = [];
							for (var m = 0; m < n.floor.surfaces.length; m++) {
								for (var p = n.floor.surfaces[m], u = {
										surface: p.type,
										colliders: []
									}, h = 0; h < p.collision.length; h++) u.colliders.push(s.transform(p.collision[h], this.pos, this.rot, this.scale));
							...
							for (var f = 0; f < n.ceiling.scopeIn.length; f++) this.ceiling.scopeIn.push(s.transform(n.ceiling.scopeIn[f], this.pos, this.rot, this.scale));
							for (var b = 0; b < n.ceiling.scopeOut.length; b++) this.ceiling.scopeOut.push(s.transform(n.ceiling.scopeOut[b], this.pos, this.rot, this.scale));
							this.imgs = [];
							for (var y = 0; y < n.floor.imgs.length; y++) this.imgs.push({
								sprite: c(n.floor.imgs[y]),
								isCeiling: !1,
								waterRipples: !!n.floor.imgs[y].waterRipples,
								zOrd: this.zIdx,
								zIdx: 100 * this.__id + y
							});
							for (var x = 0; x < n.ceiling.imgs.length; x++) this.imgs.push({
								sprite: c(n.ceiling.imgs[x]),
								isCeiling: !0,
								waterRipples: !1,
								zOrd: 750 - this.zIdx,
					...
					value: function(e, t, a, i, n, s, c) {
						if (this.ceilingDead && !this.playedCeilingDeadFx && (t.deadCeilingIds.push(this.__id), this.playedCeilingDeadFx = !0, this.isNew || this.destroyCeilingFx(a, i)), this.isNew = !1, this.ceilingDead && !this.residue) {
							var d = l.Defs[this.type];
							if (void 0 !== d.ceiling.destroy) {
								var p = this.allocSprite();
								p.texture = r.Texture.fromImage(d.ceiling.destroy.residue), p.position.set(0, 0), p.scale.set(1, 1), p.rotation = 0, p.visible = !0, this.imgs[0].sprite.addChild(p), this.residue = p
							}
						}
						var u = this.ceiling;
						u.visionTicker -= e;
						for (var g = !1, f = u.vision, b = 0; b < u.scopeIn.length; b++) {
							if (m.scanCollider(u.scopeIn[b], t.obstaclePool.getPool(), n.pos, n.layer, .5, 2 * f.width, f.dist, 5)) {
								g = !0;
								break
							}
						}
						this.ceilingDead && (g = !0), g && (u.visionTicker = f.linger + 1e-4), n.noCeilingRevealTicker > 0 && (u.visionTicker = 0);
						var y = u.visionTicker > 0,
							x = o(u.fadeAlpha, y ? 0 : 1, e * (y ? 12 : f.fadeRate));
						u.fadeAlpha += x;
						for (var v = 0; v < this.imgs.length; v++) {
							var k = this.imgs[v],
								_ = k.isCeiling ? u.fadeAlpha : 1;
							this.positionSprite(k.sprite, _, c);
							var w = this.layer;
							k.isCeiling && (this.layer == n.layer || 2 & n.layer && 1 == this.layer) && (w |= 2), s.addPIXIObj(k.sprite, h.World, w, k.zOrd, k.zIdx)
						}
					}
				}, {
					key: "destroyCeilingFx",
					value: function(e, t) {
						for (var a = l.Defs[this.type].ceiling.destroy, i = this.surfaces[0], o = 0; o < i.colliders.length; o++) {
							for (var n = s.toAabb(i.colliders[o]), r = 0; r < a.particleCount; r++) {
								var m = d.create(c.random(n.min.x, n.max.x), c.random(n.min.y, n.max.y)),
									u = d.mul(d.randomUnit(), c.random(0, 15));
								e.addParticle(p.Defs[a.particle], this.layer, m, u)
							}
							break
						}
	...
	R4DZ: function(e, t, a) {
		...
		var i = {
			...
			"game-9mm": "9 à¸¡à¸¡.",
			"game-9mm-tooltip": "à¸à¸£à¸°à¸ªà¸¸à¸™à¸ªà¸³à¸«à¸£à¸±à¸š M9, G18C, MP5, MAC-10, UMP9 à¹à¸¥à¸° Vector",
			"game-12gauge": "12 à¹€à¸à¸ˆà¹Œ",
			"game-12gauge-tooltip": "à¸à¸£à¸°à¸ªà¸¸à¸™à¸ªà¸³à¸«à¸£à¸±à¸š M870, SPAS-12, Saiga-12 à¹à¸¥à¸° MP220",
			"game-762mm": "7.62 à¸¡à¸¡.",
			"game-762mm-tooltip": "à¸à¸£à¸°à¸ªà¸¸à¸™à¸ªà¸³à¸«à¸£à¸±à¸š AK-47, SCAR-H, M39, Mosin-Nagant, SV-98, OT-38 à¹à¸¥à¸° DP-28",
			"game-556mm": "5.56mm",
			"game-556mm-tooltip": "à¸à¸£à¸°à¸ªà¸¸à¸™à¸ªà¸³à¸«à¸£à¸±à¸š FAMAS, M416, Mk 12 à¹à¸¥à¸° M249.",
	...
	RCak: function(e, t, a) {
		...
		var i = {
			...
			"game-9mm": "9mm",
			"game-9mm-tooltip": "Ammo fÃ¶r M9, G18C, MP5, MAC-10, UMP9 och Vector.",
			"game-12gauge": "12 gauge",
			"game-12gauge-tooltip": "Ammo fÃ¶r M870, SPAS-12, Saiga-12 och MP220.",
			"game-762mm": "7.62mm",
			"game-762mm-tooltip": "Ammo fÃ¶r AK-47, SCAR-H, M39, Mosin-Nagant, SV-98, OT-38 och DP-28.",
			"game-556mm": "5.56mm",
			"game-556mm-tooltip": "Ammo fÃ¶r FAMAS, M416, Mk 12 och M249.",
	...
	SEs0: function(e, t, a) {
		...
		l(document).ready(function() {
			...
			l("#btn-join-team").click(function() {
				return l("#server-warning").css("display", "none"), n.val(""), t.css("display", "block"), a.css("display", "block"), i.css("display", "none"), e.css("display", "none"), m.css("display", "none"), s.css("display", "none"), !1
	...
	UWg4: function(e, t, a) {
		...
		var i = {
			...
			"game-9mm": "9æ¯«ç±³",
			"game-9mm-tooltip": "ç»™M9,MP5,G18C,Mac-10, Vector å’Œ UMP9çš„å¼¹è¯ã€‚",
			"game-12gauge": "12å£å¾„",
			"game-12gauge-tooltip": "ç»™M870, SPAS-12, Saiga-12 å’Œ MP220çš„å¼¹è¯ã€‚",
			"game-762mm": "7.62æ¯«ç±³",
			"game-762mm-tooltip": "ç»™AK-47, SCAR-H, M39, èŽ«è¾›-çº³ç”˜æ­¥æžª, M39ï¼Œ SV-98, OT-38 å’Œ DP-28çš„å¼¹è¯ã€‚",
			"game-556mm": "5.56æ¯«ç±³",
			"game-556mm-tooltip": "ç»™FAMAS, M416, Mk 12 å’Œ M249å¼¹è¯ã€‚",
			...
			d = (a("zinx"), function() {
				...
				return n(e, [{
					...
					value: function() {
						...
						if (i.css("opacity", _ ? 1 : 0), i.html(w), p && (r("#team-menu-joining-text").css("display", h ? "none" : "block"), r("#team-menu-creating-text").css("display", h ? "block" : "none"), r("#team-menu-connecting").css("display", u ? "none" : "block"), r("#team-menu-contents").css("display", u ? "block" : "none")), u) {
							...
							var E = r("#team-menu-member-list");
							E.empty();
							for (var L = 0; L < b.teamMode; L++) {
								var B = {
									name: "",
									playerId: 0,
									isLeader: !1,
							...
							r(".icon-kick", E).click(function(t) {
							...
							var q = y.find(function(e) {
								...
								V = q && !q.inGame;
							!document.hasFocus() && this.prevPlayerCount < y.length && y.length > 1 && V && k.playSound("notification_join_01", {
								channel: "ui"
	...
	a5N1: function(e, t, a) {
		...
		var i = {
			...
			"game-9mm": "9mm",
			"game-9mm-tooltip": "Äáº¡n cho sÃºng M9, G18C, MP5, MAC-10, UMP9 vÃ  Vector.",
			"game-12gauge": "cá»¡ 12",
			"game-12gauge-tooltip": "Äáº¡n cho sÃºng M870, SPAS-12, Saiga-12 vÃ  MP220.",
			"game-762mm": "7.62mm",
			"game-762mm-tooltip": "Äáº¡n cho sÃºng AK-47, SCAR-H, M39, Mosin-Nagant, SV-98, OT-38 vÃ  DP-28.",
			"game-556mm": "5.56mm",
			"game-556mm-tooltip": "Äáº¡n cho sÃºng FAMAS, M416, Mk 12 vÃ  M249.",
			"game-50AE": ".50 AE",
		...
		o.prototype = {
			...
			update: function(e, t, a, i, o, n) {
				for (var r = this.deadBodyPool.getPool(), l = 0; l < r.length; l++) {
					var c = r[l];
					if (c.active) {
						c.nameTextSet || (c.nameTextSet = !0, c.nameText.text = t.getPlayerInfo(c.playerId).name);
						var d = s.createCircle(c.pos, 1),
							m = i.insideStructureStairs(d),
							p = c.layer,
							h = 12;
						0 == c.layer && 0 == a.layer && m && (p |= 2, h += 100), n.addPIXIObj(c.container, u.DeadBody, p, h, c.__id);
						var g = o.pointToScreen(c.pos),
							f = o.pixels(1);
						c.container.position.set(g.x, g.y), c.container.scale.set(f, f)
					}
				}
			},
	...
	"eqS/": function(e, t, a) {
		...
		var i = {
			...
			"game-9mm": "9mm",
			"game-9mm-tooltip": "M9, G18C, MP5, MAC-10, UMP9 ve Vector iÃ§in cephane.",
			"game-12gauge": "12 kalibre",
			"game-12gauge-tooltip": "M870, SPAS-12, Saiga-12 ve MP220 iÃ§in cephane.",
			"game-762mm": "7.62mm",
			"game-762mm-tooltip": "AK-47, SCAR-H, M39, Mosin-Nagant, SV-98, OT-38 ve DP-28 iÃ§in cephane.",
			"game-556mm": "5.56mm",
			"game-556mm-tooltip": "FAMAS, M416, Mk 12 ve M249 iÃ§in cephane.",
	...
	kIX4: function(e, t, a) {
		...
		var i = {
			...
			"game-9mm": "9æ¯«ç±³",
			"game-9mm-tooltip": "M9, G18C, MP5, Vector, MAC-10å’ŒUMP9å½ˆè—¥ã€‚",
			"game-12gauge": "12è¨ˆ",
			"game-12gauge-tooltip": "M870, SPAS-12, Saiga-12 å’Œ MP220å½ˆè—¥ã€‚",
			"game-762mm": "7.62æ¯«ç±³",
			"game-762mm-tooltip": "AK-47, SCAR-H, M39, Mosin-Nagant, SV-98, OT-38 å’Œ DP-28å½ˆè—¥ã€‚",
			"game-556mm": "5.56mm",
			"game-556mm-tooltip": "FAMAS, M416, Mk 12 å’Œ M249å½ˆè—¥ã€‚",
	...
	"m1+W": function(e, t, a) {
		...
		o.prototype = {
			...
			init: function() {
				...
				this.input = new C.InputHandler(this.pixi.view), this.touch = new N.Touch(this.input, this.config), this.camera = new x, this.renderer = new F(t), this.particleBarn = new D.ParticleBarn(this.renderer), this.map = new z, this.playerBarn = new E.PlayerBarn, this.bulletBarn = new y.BulletBarn, this.projectileBarn = new L.ProjectileBarn, this.explosionBarn = new S.ExplosionBarn, this.smokeBarn = new j.SmokeBarn, this.deadBodyBarn = new v.DeadBodyBarn, this.decalBarn = new _.DecalBarn, this.lootBarn = new I.LootBarn, this.gas = new P(t), this.pieTimer = new O.PieTimer, this.uiManager = new q.UiManager(this, this.audioManager, this.pieTimer, this.particleBarn, this.localization, t, this.touch), this.ui2Manager = new V.Ui2Manager(this.localization), this.emoteManager = new w.EmoteManager(this, this.audioManager, this.uiManager, this.playerBarn, this.camera, this.map), this.shotBarn = new R.ShotBarn(this.particleBarn, this.audioManager, this.uiManager);
			...
			update: function(e) {
				...
				if (y.seq = this.seq, !this.spectating) {
					...
					for (var z = !1, A = 0; A < k.uiEvents.length; A++) {
						...
						if ("drop" == D.action) {
							...
							if ("weapon" == D.type) {
								var E = this.activePlayer.localData.weapons;
								O.item = E[D.data].name, O.weapIdx = D.data
							} else {
								var L = "";
								L = "helmet" == D.data ? this.activePlayer.netData.helmet : "chest" == D.data ? this.activePlayer.netData.chest : D.data, O.item = L
							}
				...
				for (var G = 0; G < this.emoteManager.newPings.length; G++) {
					var U = this.emoteManager.newPings[G],
						W = new u.EmoteMsg;
					W.type = U.type, W.pos = U.pos, W.useLoadout = !1, W.teamOnly = !0, W.isPing = !0, this.sendMessage(u.Msg.Emote, W)
				}
				this.emoteManager.newPings = [];
				for (var H = 0; H < this.emoteManager.newEmotes.length; H++) {
					var K = this.emoteManager.newEmotes[H],
						X = new u.EmoteMsg;
	...
	nlKB: function(e, t, a) {
		...
		var i = {
			...
			"game-9mm": "9mm",
			"game-9mm-tooltip": "MuniÃ§Ã£o para M9, G18C, MP5, MAC-10, UMP9 e Vector.",
			"game-12gauge": "Calibre 12",
			"game-12gauge-tooltip": "MuniÃ§Ã£o para M870, SPAS-12, Saiga-12 e MP220.",
			"game-762mm": "7.62mm",
			"game-762mm-tooltip": "MuniÃ§Ã£o para AK-47, SCAR-H, M39, Mosin-Nagant, SV-98, OT-38 e DP-28.",
			"game-556mm": "5.56mm",
			"game-556mm-tooltip": "MuniÃ§Ã£o para FAMAS, M416, Mk 12 e M249.",
	...
	pQi2: function(e, t, a) {
		...
		var r = function() {
			...
			C = function() {
				function e() {
					o(this, e), this.container = new s.Container, this.gunContainerL = new s.Container, this.gunContainerR = new s.Container, this.skinType = "outfitBase";
					var t = l.items[this.skinType];
					this.footSpriteName = "img/player/player-feet-01.svg", this.footLt = h.create(-20, -35), this.footRt = h.create(20, -35), this.foot_left = s.Sprite.fromImage(this.footSpriteName), this.foot_left.anchor.set(.5, .5), this.foot_left.scale.set(.45, .45), this.foot_left.pivot.set(this.footLt.x, this.footLt.y), this.foot_left.tint = t.skinImg.handTint, this.foot_left.visible = !1, this.foot_left_submerge = s.Sprite.fromImage(this.footSpriteName), this.foot_left_submerge.anchor.set(.5, .5), this.foot_left_submerge.tint = y.water, this.foot_left_submerge.visible = !1, this.foot_left_submerge.alpha = 0, this.foot_left.addChild(this.foot_left_submerge), this.container.addChild(this.foot_left), this.foot_right = s.Sprite.fromImage(this.footSpriteName), this.foot_right.anchor.set(.5, .5), this.foot_right.scale.set(.45, .45), this.foot_right.pivot.set(this.footRt.x, this.footRt.y), this.foot_right.tint = t.skinImg.handTint, this.foot_right.visible = !1, this.foot_right_submerge = s.Sprite.fromImage(this.footSpriteName), this.foot_right_submerge.anchor.set(.5, .5), this.foot_right_submerge.tint = y.water, this.foot_right_submerge.visible = !1, this.foot_right_submerge.alpha = 0, this.foot_right.addChild(this.foot_right_submerge), this.container.addChild(this.foot_right), this.backpack = s.Sprite.fromImage("img/player/circle-base-01.svg"), this.backpack.anchor.set(.5, .5), this.backpack.scale.set(.4, .4), this.backpack.tint = t.skinImg.backpackTint, this.container.addChild(this.backpack), this.baseSpriteName = t.skinImg.baseSprite, this.sprite = s.Sprite.fromImage(this.baseSpriteName), this.sprite.anchor.set(.5, .5), this.sprite.scale.set(.5 * t.skinImg.baseScale, .5 * t.skinImg.baseScale), this.sprite.tint = t.skinImg.baseTint, this.container.addChild(this.sprite), this.gunBot = s.Sprite.fromImage("img/guns/gun-short-01.svg"), this.gunBot.anchor.set(.5, .75), this.gunBot.scale.set(.5, .5), this.gunBot.pivot.set(0, 110), this.gunBot.visible = !1, this.gunContainerL.addChild(this.gunBot), this.gunBotVis = !1, this.gunOffhand = s.Sprite.fromImage("img/guns/gun-short-01.svg"), this.gunOffhand.anchor.set(.5, .75), this.gunOffhand.scale.set(.5, .5), this.gunOffhand.pivot.set(0, 110), this.gunOffhand.visible = !1, this.gunContainerR.addChild(this.gunOffhand), this.gunOffhandVis = !1, this.gun = s.Sprite.fromImage("img/guns/gun-short-01.svg"), this.gun.anchor.set(.5, .75), this.gun.scale.set(.5, .5), this.gun.pivot.set(0, 110), this.gunContainerL.addChild(this.gun), this.gunVis = !1, this.chest = s.Sprite.fromImage("img/player/armor-base-01.svg"), this.chest.anchor.set(.5, .5), this.chest.scale.set(.5, .5), this.container.addChild(this.chest), this.submergedMask = s.Sprite.fromImage("img/player/player-base-01.svg"), this.submergedMask.anchor.set(.5, .5), this.submergedMask.scale.set(.6, .6), this.container.addChild(this.submergedMask), this.submerged = s.Sprite.fromImage("img/player/player-wading-01.svg"), this.submerged.anchor.set(.5, .5), this.submerged.scale.set(.9, .9), this.submerged.alpha = 0, this.submerged.tint = 2854052, this.submerged.mask = this.submergedMask, this.submerged.visible = !0, this.container.addChild(this.submerged), this.submersion = 0, this.handSpriteName = t.skinImg.handSprite, this.hand_left = s.Sprite.fromImage(this.handSpriteName), this.hand_left.anchor.set(.5, .5), this.hand_left.scale.set(.35, .35), this.hand_left.pivot.set(35, 40), this.hand_left.tint = t.skinImg.handTint, this.hand_left_submerge = s.Sprite.fromImage(this.handSpriteName), this.hand_left_submerge.anchor.set(.5, .5), this.hand_left_submerge.tint = y.water, this.hand_left_submerge.visible = !1, this.hand_left_submerge.alpha = 0, this.hand_left.addChild(this.hand_left_submerge), this.gunContainerL.addChild(this.hand_left), this.hand_right = s.Sprite.fromImage(this.handSpriteName), this.hand_right.anchor.set(.5, .5), this.hand_right.scale.set(.35, .35), this.hand_right.pivot.set(-35, 40), this.hand_right.tint = t.skinImg.handTint, this.hand_right_submerge = s.Sprite.fromImage(this.handSpriteName), this.hand_right_submerge.anchor.set(.5, .5), this.hand_right_submerge.tint = y.water, this.hand_right_submerge.visible = !1, this.hand_right_submerge.alpha = 0, this.hand_right.addChild(this.hand_right_submerge), this.gunContainerR.addChild(this.hand_right), this.object_left = s.Sprite.from(s.Texture.EMPTY), this.object_left.anchor.set(.5, .5), this.object_left.pivot.set(0, 0), this.object_left.visible = !1, this.hand_left.addChild(this.object_left), this.object_right = s.Sprite.from(s.Texture.EMPTY), this.object_right.anchor.set(.5, .5), this.object_right.visible = !1, this.hand_right.addChild(this.object_right), this.handLt = h.create(35, 40), this.handRt = h.create(-35, 40), this.gunHandLt = h.copy(this.handLt), this.gunHandRt = h.copy(this.handRt), this.objHandLt = h.copy(this.handLt), this.objHandRt = h.copy(this.handRt), this.gunHandLtVis = !0, this.gunHandRtVis = !0, this.objLtVis = !1, this.objRtVis = !1, this.gunTop = s.Sprite.fromImage("img/guns/gun-short-01.svg"), this.gunTop.anchor.set(.5, 1), this.gunTop.scale.set(.5, .5), this.gunTop.pivot.set(0, 110), this.gunTop.visible = !1, this.gunContainerL.addChild(this.gunTop), this.gunTopVis = !1, this.container.addChild(this.gunContainerL), this.container.addChild(this.gunContainerR), this.helmet = s.Sprite.fromImage("img/player/circle-base-01.svg"), this.helmet.anchor.set(.5, .5), this.helmet.scale.set(.3, .3), this.container.addChild(this.helmet), this.nameText = n(), this.nameText.visible = !1, this.container.addChild(this.nameText), this.anim = {
						type: d.None,
						seq: 0,
						frame: 0,
						timer: 0,
				...
				return r(e, [{
					...
					key: "getBagLevel",
					value: function() {
						return l.items[this.netData.backpack].level
					}
				}, {
					key: "equippedWeaponType",
					value: function() {
						return l.items[this.netData.curWeapType].type
					}
				}, {
					key: "hasWeaponInSlot",
					value: function(e) {
					...
					value: function(e, t) {
						...
						var c = Math.min(r / n[l].time, 1),
							...
							u = n[l].handLt,
							f = n[l].handRt;
						if (this.handLt = g.v2lerp(c, m, u), this.handRt = g.v2lerp(c, p, f), a.mirror && this.anim.mirror) {
						...
						if (a.feet) {
							var y = s >= 0 ? n[s].footLt : this.anim.startFootLt,
								...
								k = n[l].footLt,
								_ = n[l].footRt;
							if (this.footLt = g.v2lerp(c, y, k), this.footRt = g.v2lerp(c, v, _), a.mirror && this.anim.mirror) {
					...
					key: "playAnimSound",
					value: function(e, t) {
						var a = l.items[this.netData.curWeapType],
							i = a.sound[t];
					...
					value: function(e) {
						...
						e.particleBarn.addParticle(M.Defs.fragPin, this.layer, h.add(this.pos, t), h.mul(h.rotate(this.dir, .5 * Math.PI), 4.5));
						var a = h.rotate(h.create(.75, -.75), Math.atan2(this.dir.y, this.dir.x));
						e.particleBarn.addParticle(M.Defs.fragLever, this.layer, h.add(this.pos, a), h.mul(h.rotate(this.dir, .25 * -Math.PI), 3.5))
					}
				}, {
					key: "doMeleeCollision",
					value: function(e) {
						for (var t = l.items[this.netData.curWeapType], a = h.add(this.pos, h.mul(this.dir, t.rangeMult)), i = t.areaOfEffect, o = [], n = null, r = null, s = 0, c = e.map.obstaclePool.getPool(), d = 0; d < c.length; d++) {
							var m = c[d];
							if (!(!m.active || m.dead || m.height < l.player.meleeHeight) && u.sameLayer(m.layer, 1 & this.layer)) {
						...
						for (var k = e.playerBarn.playerPool.getPool(), _ = 0; _ < k.length; _++) {
							var w = k[_];
							if (w.active && w.__id != this.__id && !w.netData.dead && u.sameLayer(w.layer, this.layer)) {
								if (f.testCircleCircle(h.add(this.pos, h.mul(this.dir, t.rangeMult)), t.areaOfEffect, w.pos, l.player.radius) && g.eqAbs(v.intersectSegment(e.map.obstaclePool.getPool(), this.pos, this.dir, t.rangeMult, l.player.meleeHeight, this.layer, !1), t.rangeMult)) {
									var S = h.mul(this.dir, 1);
									S = h.rotate(S, (Math.random() - .5) * Math.PI / 3), o.push({
										pos: w.pos,
										vel: S,
										particle: "bloodSplat",
										sound: "punch_hit_01",
						...
						for (var T = 0; T < o.length; T++) {
							var P = o[T];
							e.particleBarn.addParticle(M.Defs[P.particle], this.layer, P.pos, P.vel), e.audioManager[P.soundFn](P.sound, {
								channel: "hits",
								soundPos: P.pos,
								layer: this.layer,
								muffled: !0
			...
			I = function() {
				...
				return r(e, [{
					key: "update",
					value: function(e, t, a, i, o, n, r, s, g, f, y, k) {
						for (var w = {
								playerBarn: this,
								map: n,
								audioManager: s,
	...
	pb8F: function(e, t, a) {
		...
		var i = {
			...
			"game-9mm": "9mm",
			"game-9mm-tooltip": "MuniciÃ³n para la M9, G18C, MP5, MAC-10, UMP9 y Vector.",
			"game-12gauge": "Calibre 12",
			"game-12gauge-tooltip": "MuniciÃ³n para la M870, SPAS-12, Saiga-12 y MP220.",
			"game-762mm": "7,62mm",
				...
				return n(e, [{
					...
					value: function() {
						...
						!this.loading && d.getCookie("app-data") && (this.loading = !0, this.render(), o("/api/user/profile", function(t, a) {
							if (t) m.storeGeneric("account", "load_error");
					...
					value: function() {
						...
						this.config.set("profile", null), o("/api/user/delete", function(t, a) {
							if (t) return m.storeGeneric("account", "delete_error"), void e.displayError("server_error");
							window.location.href = "/"
						})
					}
				}, {
					...
					value: function(e, t) {
						...
						o("/api/user/username", {
							...
							if (e) return m.storeGeneric("account", "set_username_error"), void t("Failed setting username.");
					...
					value: function(e) {
						...
						this.loggedIn && e != this.profile.avatar && o("/api/user/avatar", {
							...
							if (e) return m.storeGeneric("account", "set_avatar_error"), void t.displayError("server_error");
							t.load()
						})
					}
				}, {
				...
				intersectSegment: function(e, t, a, r, s, l, c) {
					for (var d = r, m = n.add(t, n.mul(a, r)), p = 0; p < e.length; p++) {
						...
						if (!(!u.active || u.dead || !u.collidable || u.isWindow || u.height < s) && o.sameLayer(u.layer, l) && !(c && 2 & l && 0 == u.layer)) {
							var h = i.intersectSegment(u.collider, t, m);
							h && (d = Math.min(d, n.length(n.sub(h.point, t))))
						}
					}
					return d
				},
				scanCollider: function(e, t, a, o, c, d, m, p) {
					var u = i.intersectCircle(e, a, m);
					if (!u) return !1;
					if (u.pen >= m) return !0;
					...
					for (var x = c, v = 0; v < g.length; v++) {
						var k = g[v],
							_ = n.sub(k, a),
							w = n.length(_);
						_ = w > 1e-4 ? n.div(_, w) : n.create(1, 0);
						var S = l.intersectSegment(t, a, _, w, 0, o, !1);
						k = n.add(a, n.mul(_, S));
						var M = i.intersectCircle(e, k, m);
						if (M) {
							var T = n.neg(M.dir),
								P = l.intersectSegment(t, k, T, m, x, o, !0),
								C = i.intersectSegment(e, k, n.add(k, n.mul(T, m))),
								I = C && n.length(n.sub(C.point, k)) <= P;
							if (r.debug) {
					...
					value: function(e, t, a, i, o, n, p) {
						for (var u = this.projectilePool.getPool(), f = 0; f < u.length; f++) {
							...
							if (b.active) {
								...
								!(b.posZ >= .25 && F && (1 & b.layer) == (1 & i.layer)) || R && 2 & i.layer || (E |= 2, L += 100), n.addPIXIObj(b.sprite, h.World, E, L);
			...
			update: function(e, t, a, i, o, u, g, f) {
				for (var b = t.playerPool.getPool(), y = 0; y < this.bullets.length; y++) {
					...
					if (x.collided && (x.scale = Math.max(x.scale - 6 * e, 0), x.scale <= 0 && (x.collided = !1, x.container.visible = !1)), x.alive) {
						...
						var E = !1,
							L = t.getPlayerById(x.playerId);
						L && (L.netData.dead || L.netData.downed) && (E = !0);
						...
						if (!(2 & x.layer)) {
							for (var V = a.structurePool.getPool(), G = x.layer, U = 0; U < V.length; U++) {
								var W = V[U];
								if (W.active) {
									for (var H = !1, K = !1, X = 0; X < W.stairs.length; X++)
										if (l.intersectSegment(W.stairs[X].collision, x.pos, _)) {
											H = !0;
											break
										}
									for (var Y = 0; Y < W.mask.length; Y++)
										if (l.intersectSegment(W.mask[Y], x.pos, _)) {
											K = !0;
											break
										}
									H && !K && (G |= 2)
				...
				return n(e, [{
					...
					value: function() {
						...
						if (!this.initialized) {
							...
							this.game = new g(D, t, m, a, O, E), this.onResize(), this.tryJoinTeam(!1), this.audioManager.preloadSounds(), this.menuMusicIdx = t.queueSound("menu_music", {
								channel: "music",
								fadeIn: !0,
								loop: !1,
								forceStart: !0
					...
					value: function(e, t) {
						...
						if (0 != (a & j.Emotes))
							for (var D = e.readUint8(), O = 0; O < D; O++) {
								var E = {};
								E.type = e.readUint8(), E.isPing = e.readUint8(), E.playerId = e.readUint16(), E.pos = e.readVec(0, 0, 1024, 1024, 16), this.emotes.push(E)
							}
	...
	zgif: function(e, t, a) {
		...
		var o = function() {
			...
			s = (a("0od3"), a("Bk7F")),
			l = a("/2+T"),
			c = (a("zinx"), a("w0e4"), a("r4ug"), function() {
				function e() {
					i(this, e)
				}
				return o(e, [{
					...
					value: function(e, t, a, i) {
						if (t) {
							this.type = e.type, this.layer = 0, this.pos = l.copy(e.pos), this.rot = s.oriToRad(e.ori), this.scale = 1, this.aabb = r.transform(s.getBoundingCollider(this.type), this.pos, this.rot, this.scale), this.stairs = [];
							for (var o = s.Defs[this.type], c = 0; c < o.stairs.length; c++) {
								var d = o.stairs[c],
									m = r.transform(d.collision, this.pos, this.rot, this.scale),
							...
							this.mask = [];
							for (var h = 0; h < o.mask.length; h++) this.mask.push(r.transform(o.mask[h], this.pos, this.rot, this.scale));
...
//# sourceMappingURL=app.2c9a1f93.js.map